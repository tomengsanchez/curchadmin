...
$router->get('/account/sessions', 'SessionsController@index');
$router->post('/account/sessions/logout-others', 'SessionsController@logoutOthers');
$router->post('/account/sessions/logout/{id}', 'SessionsController@logoutSession');
...
$router->get('/grievance/respondents', 'GrievanceController@respondents');
...
$router->post('/grievance/options/progress-levels/initialize-project', 'GrievanceOptionsController@progressLevelsInitializeProject');
$router->post('/grievance/options/progress-levels/remap-project', 'GrievanceOptionsController@progressLevelsRemapProject');
...
$router->get('/api/respondents/first-names', 'Api\ApiController@respondentFirstNames');
$router->get('/api/respondents/middle-names', 'Api\ApiController@respondentMiddleNames');
$router->get('/api/respondents/last-names', 'Api\ApiController@respondentLastNames');
$router->get('/api/respondents/history', 'Api\ApiController@respondentHistory');
$router->get('/api/respondents/latest-details', 'Api\ApiController@respondentLatestDetails');
