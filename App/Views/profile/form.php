        ...
        <form method="post" action="<?= $prof ? "/profile/update/{$prof->id}" : '/profile/store' ?>" enctype="multipart/form-data" id="profileForm">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="first_name" class="form-control" value="<?= htmlspecialchars($prof->first_name ?? '') ?>">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label">Middle Name</label>
                    <input type="text" name="middle_name" class="form-control" value="<?= htmlspecialchars($prof->middle_name ?? '') ?>">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label">Last Name</label>
                    <input type="text" name="last_name" class="form-control" value="<?= htmlspecialchars($prof->last_name ?? '') ?>">
                </div>
            </div>
            <div class="mb-3">
